...
func init() {
	RegisterMigration(Migration{
		...
		Up:      migration023RepoRegistryAndSettings,
	})
}

// migration023RepoRegistryAndSettings creates the repo_registry and
...
func migration023RepoRegistryAndSettings(tx *sql.Tx) error {
	statements := []string{
