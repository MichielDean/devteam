...
func init() {
	RegisterMigration(Migration{
		...
		Up:      migration022CredentialsTable,
	})
}

// migration022CredentialsTable creates the credentials table for encrypted
...
func migration022CredentialsTable(tx *sql.Tx) error {
	statements := []string{
