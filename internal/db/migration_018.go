...
func init() {
	RegisterMigration(Migration{
		...
		Up:      migration018RepoOperationConfig,
	})
}

// migration018RepoOperationConfig creates the per-repo operation-phase
...
func migration018RepoOperationConfig(tx *sql.Tx) error {
	statements := []string{
