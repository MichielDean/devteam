...
func init() {
	RegisterMigration(Migration{
		...
		Up:      migration024AuditCredentialTouched,
	})
}

// migration024AuditCredentialTouched adds the credential_touched column to
...
func migration024AuditCredentialTouched(tx *sql.Tx) error {
	statements := []string{
