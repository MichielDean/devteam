...
- Add notes: `devteam notes add playwright-e2e --phase delivery --content "what you decided"`
...
You are in the DELIVERY phase for feature playwright-e2e.
...
Write documentation to specs/playwright-e2e/docs/ with:
